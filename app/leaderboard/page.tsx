  ...
  return (
    <main className="relative w-full min-h-screen">
      ...
      <div className="w-full mx-auto flex flex-col items-center justify-center min-h-screen py-4 md:py-8 px-4 pb-20 md:pb-8">
        ...
        <Link 
          href="/"
          className={`${styles.buttonText} fixed left-1/2 -translate-x-1/2 bottom-8 px-6 md:px-8 py-2 rounded-full bg-[#2162DD] border-[#2162DD] border hover:bg-transparent hover:text-[#2162DD] transition-all duration-500 z-50 text-sm md:text-base`}
        >
          Retour à l'accueil
        </Link>
      </div>
