...
export default function ScoreBadge({ score }: ScoreBadgeProps) {
  ...
  return (
    <div 
      className={`${styles.textBadge} absolute top-8 right-4 md:right-[86px] w-32 md:w-[172px] h-10 bg-white rounded-full flex items-center justify-center px-4 py-1 mr-4 md:mr-0`}
    >
